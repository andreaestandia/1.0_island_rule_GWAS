...
```bash
PATH_WD="/media/sjoh4959/My\ Passport/Andrea/projects/1.0_island_rule_GWAS/reports/GWAS/outliers/list_outliers/"
PATH_WGS="/media/sjoh4959/My\ Passport/Andrea/projects/1.0_island_rule_GWAS/data/GWAS/input_beagle/"
PATH_OUT="/media/sjoh4959/My\ Passport/Andrea/projects/1.0_island_rule_GWAS/reports/GWAS/outliers/beagle/"
declare -a trait_list=("wing" "tarsus" "head" "body_pc1" "body_pc2" "bill_pc1" "bill_pc2" "bill_length" "bill_depth" "bill_depth")
for trait in "${trait_list[@]}"
do
	zcat "${PATH_WGS}${trait}.beagle.gz" | grep -w -f "${PATH_WD}${trait}_outliers.csv" > "${PATH_OUT}${trait}_outliers.beagle"
done
```

```
zcat /media/sjoh4959/My\ Passport/Andrea/projects/1.0_island_rule_GWAS/data/GWAS/input_beagle/bill_depth.beagle.gz | grep -w -f /media/sjoh4959/My\ Passport/Andrea/projects/1.0_island_rule_GWAS/reports/GWAS/outliers/list_outliers/bill_depth_outliers.csv > bill_depth_outliers.beagle &
```
...
# Outlier MDS to cov matrix

```bash
CHOSEN_FILE="/data/Users/Andrea/silvereye/projects_data/0.0_island_rule/analysis/localPCA/outlier_mds/unpruned/cluster_outlier_allMDS_max4_merge5_filter3_sdLim4.pos"


num_pca=$(wc -l "$CHOSEN_FILE" | cut -d " " -f 1)

path_beagle_all="/data/Users/Andrea/silvereye/wgs_beagle/raw/"
path_beagle_subset="/data/Users/Andrea/silvereye/projects_data/0.0_island_rule/analysis/localPCA/outlier_mds/unpruned/"
PATH_PCANGSD="/home/zoo/sjoh4959/sjoh4959/projects/0.0_island_rule/src/others/pcangsd/"
