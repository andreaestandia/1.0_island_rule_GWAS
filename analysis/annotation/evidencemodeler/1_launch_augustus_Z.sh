...
--hintsfile="${PATH_INPUT}chromosomeZ/zosterops_hints_RM_E.gff3" \
...
"${PATH_INPUT}chromosomeZ/ref_genome_chr.fasta.masked" > "output/zosterops_augustus_chromosomeZ.gff"
#
