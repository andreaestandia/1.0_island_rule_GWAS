...
$PATH_EVM "${PATH_INPUT}zosterops_augustus_chromosome1A.gff" > "${PATH_INPUT}zosterops_augustus_chromosome1A.gff3"
grep "CDS" "${PATH_INPUT}zosterops_augustus_chromosome1A.gff3" > "${PATH_INPUT}zosterops_augustus_chromosome1A_CDS.gff3"
bedtools getfasta -fi $PATH_REF -bed "${PATH_INPUT}zosterops_augustus_chromosome1A_CDS.gff3" -fo "${PATH_INPUT}zosterops_augustus_chromosome1A_CDS.fasta"
